...
/* ===============================
   FORM DE CONTACTO — FORMSPREE
   =============================== */
function ContactForm() {
  const [status, setStatus] = useState<'idle' | 'sending' | 'ok' | 'error'>('idle');
  const [error, setError] = useState<string | null>(null);

  // ⚠️ TROCAR PELO TEU FORM ID DO FORMSPREE
  const FORMSPREE_ENDPOINT = 'https://formspree.io/f/xvgwnvek';
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Honeypot anti-spam (campo invisível). Se preencher, é bot → finge sucesso.
